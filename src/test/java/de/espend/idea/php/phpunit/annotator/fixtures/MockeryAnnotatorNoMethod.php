...
class MockeryAnnotatorNoMethod extends MockeryTestCase
{
    ...
    public function testWithAllows(): void
    {
        ...
        $this->dependency->allows('<warning descr="Method 'nomethod' not found in class Dependency">nomethod</warning>');
    }
}
